...
inline int em_mutex_give(em_mutex_t* mutex)
{
...
inline em_mutex_t* rt_em_get_mutex_by_init_list(em_list_t* list)
{
	return rt_em_get_struct_by_field(list, em_mutex_t, init_list);
}
inline em_mutex_t* rt_em_get_mutex_by_lock_list(em_list_t* list)
{
